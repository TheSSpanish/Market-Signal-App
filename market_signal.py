...
USA_SP500_FILTERED_TICKERS = [
    "AAPL","MSFT","AMZN","GOOGL","META","NVDA","BRK-B","JPM","V","MA","LLY","AVGO","XOM","COST","WMT",
    "JNJ","PG","HD","ABBV","BAC","KO","CRM","ORCL","PEP","CVX","MRK","AMD","MCD","ADBE","UNH",
    "CSCO","IBM","QCOM","CAT","GE","LIN","TMO","ABT","INTU","DHR"
]

USA_NASDAQ100_FILTERED_TICKERS = [
    "AAPL","MSFT","NVDA","AMZN","META","GOOGL","AVGO","COST","AMD","ADBE","NFLX","INTC","CSCO","QCOM","TMUS",
    "AMAT","INTU","TXN","ISRG","BKNG","GILD","ADI","LRCX","MU","PANW","MDLZ","ADP","VRTX","KLAC","SNPS"
]

DEFAULT_USA_SP500_WATCHLIST_TEXT = ", ".join(USA_SP500_FILTERED_TICKERS)
DEFAULT_USA_NASDAQ_WATCHLIST_TEXT = ", ".join(USA_NASDAQ100_FILTERED_TICKERS)
